...
| Diagram | Description |
| :--- | :--- |
| ![Activity Diagram](images/activity.png) | Workflow of the detection process |
| ![Architecture Diagram](images/architecture.png) | System architecture overview |
| ![Class Diagram](images/class.png) | System classes and relationships |
| ![Collaboration Diagram](images/collaboration.png) | Interaction between system components |
| ![Sequence Diagram](images/sequence.png) | Execution flow of the application |
| ![Use Case Diagram](images/usecase.png) | User interactions with the system |
| ![Result1](images/result1.png) | Classification Output 1 |
| ![Result2](images/result2.png) | Classification Output 2 |
| ![Result3](images/result3.png) | Classification Output 3 |
| ![Result4](images/result4.png) | Classification Output 4 |
| ![Result5](images/result5.png) | Classification Output 5 |
| ![Result6](images/result6.png) | Classification Output 6 |
